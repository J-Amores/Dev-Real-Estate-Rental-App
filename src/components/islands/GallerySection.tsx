// Preact island (client:visible) — port of components/sections/gallery-section.tsx.
// Black section, (n+1)*100vh tall, sticky rAF-throttled card stacking of
// mono-1..4.png; last image expands toward fullscreen from progress 0.6.
...
export function GallerySection() {
  ...
  return (
    ...
    >
      {/* Sticky container */}
      <div class="sticky top-0 h-screen overflow-hidden flex items-center justify-center px-4">
        <div class="relative w-full max-w-5xl h-[70vh] md:h-[80vh]">
          {images.map((image, index) => {
            ...
            const translateY = (1 - stackProgress) * 100; // 100% to 0%
            ...
            return (
              ...
              >
                <div
                  class="relative w-full h-full overflow-hidden rounded-xl md:rounded-2xl"
                  style={{
                    borderRadius:
